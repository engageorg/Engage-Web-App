...
describe("element binding", () => {
    ...
    it.skip("editing arrow and moving its head to bind it to element A, finalizing the" +
        "editing by clicking on element A should end up selecting A", async () => {
    ...
    it("should unbind on text element deletion by submitting empty text", async () => {
        ...
        const editor = document.querySelector(".excalidraw-textEditorContainer > textarea");
