...
describe("regression tests", () => {
    ...
    it("click-drag to select a group", () => {
        ...
        mouse.up(5, 5);
        expect(h.elements.filter((element) => h.state.selectedElementIds[element.id])
            .length).toBe(2);
    });
    ...
    it("drags selected elements from point inside common bounding box that doesn't hit any element " +
