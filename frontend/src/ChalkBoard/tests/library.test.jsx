...
describe("library", () => {
    ...
    it("drop library item onto canvas", async () => {
        ...
        const libraryItems = JSON.parse(await API.readFile("./fixtures/fixture_library.excalidrawlib", "utf8")).library[0];
        await API.drop(new Blob([JSON.stringify(libraryItems)], {
