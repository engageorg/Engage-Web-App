...
const duplicateElements = (elements, appState) => {
    ...
    const finalElements = [];
    let index = 0;
    const selectedElementIds = arrayToMap(getSelectedElements(elements, appState, true));
    ...
    bindTextToShapeAfterDuplication(finalElements, oldElements, oldIdToDuplicatedId);
