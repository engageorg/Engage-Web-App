...
describe("getElementBounds", () => {
    it("rectangle", () => {
        const [x1, y1, x2, y2] = getElementBounds(_ce({ x: 40, y: 30, w: 20, h: 10, a: Math.PI / 4, t: "rectangle" }));
    ...
    it("diamond", () => {
        const [x1, y1, x2, y2] = getElementBounds(_ce({ x: 40, y: 30, w: 20, h: 10, a: Math.PI / 4, t: "diamond" }));
    ...
    it("ellipse", () => {
        const [x1, y1, x2, y2] = getElementBounds(_ce({ x: 40, y: 30, w: 20, h: 10, a: Math.PI / 4, t: "ellipse" }));
    ...
    it("curved line", () => {
        const [x1, y1, x2, y2] = getElementBounds({
            ...
            points: [
                [0, 0],
                [67.33984375, 92.48828125],
                [-102.7890625, 52.15625],
            ],
        });
