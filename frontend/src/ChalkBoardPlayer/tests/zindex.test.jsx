...
import { actionSendBackward, actionBringForward, actionBringToFront, actionSendToBack, actionDuplicateSelection, } from "../actions";
...
const populateElements = (elements) => {
    ...
    h.elements = elements.map(({ id, isDeleted = false, isSelected = false, groupIds = [], y = 100, x = 100, width = 100, height = 100, }) => {
...
const assertZindex = ({ elements, appState, operations, }) => {
